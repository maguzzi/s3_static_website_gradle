...
public class DeleteStackCommand extends GetRoute53InfoCommand {
    ...
    public Map<String, OutputEntry> execute() throws Exception {
        ...
        String distributionStackName = CommandFactory.DISTRIBUTION_STACK_NAME + "-" + App.getEnvironment();
        logger.info("Deleting stack {}", distributionStackName);
        cloudFormationClient.deleteStack(DeleteStackRequest.builder().stackName(distributionStackName).build());

        /*
         * String bootstrapStackName =
         * "s3-static-website-bootstrap-stack-"+App.getEnvironment();
        ...
        // delete the stack return new HashMap<>();
    }
}
